...
function Services() {
    ...
    return (
        ...
        <p>OUR CORE COMPETENCE</p>
            ...
            <li>Swimming Pool Tiles/Mosaic Installation</li>
            <li>Wooden Cork Floor Installation</li>
            <li>Stamped Concrete Paving</li>
            <li>POP Wall Screeding and Keeming</li>
            <li>3D flowering and Wallpaper</li>
            <li>Waterproof Solutions</li>
            <li>Adhesive Glue (Tiles and Granites)</li>
            <li>Graunting Cement</li>
            <li>Spacers</li>
